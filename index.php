                ...
                <div class="card creditos">
                    <div class="card-mask-point creditos-img">
                        ...
                        <div class="text-creditos">
                            ...
                            <button class="help-button" aria-label="Explicação sobre pontos" data-overlay-text="Acumule pontos ao participar de atividades, completar tarefas e interagir na plataforma. Troque seus pontos por jogatinas no nosso arcade!">
                            ...
                            <div class="conversations-list" aria-label="Lista de conversas">
                                <?php if (count($formatted_conversations) > 0): ?>
                                    <?php foreach ($formatted_conversations as $conversation): ?>
                                        <a href="chat.php?friend_id=<?php echo $conversation['contact_id']; ?>" class="conversation-item" tabindex="0">
